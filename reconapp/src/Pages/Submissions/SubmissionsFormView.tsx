...
function SubmissionsFormView() {
    ...
    useEffect(() => {
        (async function () {
            const data = await GetTeamData.getFormSubmissionData(Number(team))
            const subId = Number(submissionid) - 1
            const teamData = data.data[subId]
...
export default SubmissionsFormView