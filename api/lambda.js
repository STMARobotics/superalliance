...
exports.handler = (event, context, callback) => {
  ...
  if(connection == null) {
    connection = mongoose.connect(process.env.MONGODB_URI, { maxIdleTimeMS: 60000 })
      .then(() => {
...
//       cachedMongoConn = mongoose.connect(process.env.MONGODB_URI, { maxPoolSize: 10, maxIdleTimeMS: 60000 });
//     } else {
