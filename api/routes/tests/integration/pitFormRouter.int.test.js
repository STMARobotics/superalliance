...
describe('pitFormRouter body validation (integration)', () => {
  test('returns 400 for invalid eventCode in image upload body', async () => {
    const res = await request(app)
      .post('/api/form/pit/image-upload')
      .send({ year: new Date().getFullYear(), teamNumber: '1234', eventCode: '!@', fileType: 'image/png' });
  ...
  test('returns 400 for invalid teamNumber in image upload body', async () => {
    const res = await request(app)
      .post('/api/form/pit/image-upload')
      .send({ year: new Date().getFullYear(), teamNumber: 0, eventCode: 'TEST', fileType: 'image/png' });
  ...
  test('returns 400 for missing fileType in image upload body', async () => {
    const res = await request(app)
      .post('/api/form/pit/image-upload')
      .send({ year: new Date().getFullYear(), teamNumber: 1234, eventCode: 'TEST' });
  ...
  test('returns 400 for unsupported fileType in image upload body', async () => {
    const res = await request(app)
      .post('/api/form/pit/image-upload')
      .send({ year: new Date().getFullYear(), teamNumber: 1234, eventCode: 'TEST', fileType: 'text/plain' });
...
describe('pitFormRouter body validation (integration)', () => {
  test('returns 400 for invalid eventCode in image upload body', async () => {
    const res = await request(app)
      .post('/api/form/pit/image-upload')
      .send({ year: new Date().getFullYear(), eventCode: '!@', teamNumber: 1234, fileType: 'image/png' });
  ...
  test('returns 400 for invalid teamNumber in image upload body', async () => {
    const res = await request(app)
      .post('/api/form/pit/image-upload')
      .send({ year: new Date().getFullYear(), eventCode: 'TEST', teamNumber: 0, fileType: 'image/png' });
